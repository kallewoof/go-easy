...
/**
 * Replicate the readBodyFlags function from bin/gmail.ts
 * to test it in isolation without needing the full CLI wiring.
 */
...
/**
 * Replicate parseFlags from bin/gmail.ts
 */
